...
//         try {
//           const response = await axios.get("http://127.0.0.1:8000/FPF/pg_thesis/pf_no/");
...
//             const res = await axios.post("http://127.0.0.1:8000/FPF/pg/", formData);
...
//                         <td className="border border-gray-300 p-2">{project.supervisors}</td>
